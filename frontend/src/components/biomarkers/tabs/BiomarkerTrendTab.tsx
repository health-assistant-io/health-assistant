            ...
            <div className="flex bg-gray-100 dark:bg-dark-bg p-1 rounded-xl border border-gray-200 dark:border-dark-border">
              {TIME_RANGES.map(range => (
                <button
                  ...
                  className={`px-3 py-1.5 text-[10px] font-black rounded-lg transition-all ${dateRange === range.id ? 'bg-white dark:bg-dark-surface text-blue-600 shadow-xs' : 'text-gray-500 hover:text-gray-700'}`}
                >
                  {range.shortLabel}
                </button>
              ))}
            ...
            {biomarker.is_telemetry && aggregation && (
              <div className="flex items-center ml-2 bg-gray-100 dark:bg-dark-bg p-1 rounded-xl border border-gray-200 dark:border-dark-border">
                <select
                  ...
                  className="bg-transparent text-[10px] font-black text-gray-700 dark:text-gray-300 outline-hidden cursor-pointer pl-2 pr-6 py-1.5 appearance-none"
          ...
          <div className="flex items-center space-x-1 bg-gray-100 dark:bg-dark-bg p-1 rounded-xl border border-gray-200 dark:border-dark-border">
            {[
              ...
              <button
                ...
                className={`p-1.5 rounded-lg transition-all ${chartType === type.id ? 'bg-white dark:bg-dark-surface text-blue-600 shadow-xs' : 'text-gray-500 hover:text-gray-700'}`}
