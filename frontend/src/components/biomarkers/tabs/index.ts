/**
 * Barrel for the BiomarkerDetail tab bodies. Each tab is a self-contained
 * presentational component; the detail page owns the tab strip + URL sync and
 * renders the active body. Mirrors the catalog `tabs/` extraction pattern.
 */
export { BiomarkerInfoTab } from './BiomarkerInfoTab';
