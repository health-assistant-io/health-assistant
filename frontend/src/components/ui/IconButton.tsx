...
export const IconButton: React.FC<IconButtonProps> = ({
  ...
  return (
    <button
      type="button"
      className={clsx(
        'inline-flex items-center justify-center rounded-xl transition-all active:scale-90 shrink-0 focus:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-dark-surface disabled:opacity-50 disabled:pointer-events-none',
