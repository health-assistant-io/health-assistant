    ...
    <div className={`flex flex-col gap-2 ${className}`}>
      ...
      <div ref={inputWrapRef} className={`relative ${block ? 'w-full' : ''}`}>
        ...
        <input
          ...
          className={`w-full pl-8 pr-9 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 focus:ring-2 focus:ring-blue-500 outline-hidden disabled:opacity-50 ${
            block ? 'pr-20' : ''
          }`}
        />
