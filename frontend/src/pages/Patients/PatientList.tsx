...
import { Search, Plus, User, Edit2, Trash2, Calendar, Fingerprint, ChevronRight, Users } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <FormModal
        ...
        title={editingPatient ? t('patients.edit_profile') : t('patients.add_new')}
        icon={
        ...
        submitLabel={editingPatient ? t('patients.update_profile') : t('patients.create_patient')}
