        ...
        actions={
          <>
            <button
              ...
              className="flex items-center space-x-2 px-6 py-2.5 bg-white dark:bg-dark-surface border border-gray-200 dark:border-dark-border text-brand-navy dark:text-dark-text rounded-xl font-bold text-sm hover:bg-gray-50 transition-all shadow-xs active:scale-95"
            >
