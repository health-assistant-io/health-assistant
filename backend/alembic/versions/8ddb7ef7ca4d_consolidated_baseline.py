...
def upgrade() -> None:
    ...
    sa.Column('value_type', sa.Enum('quantity', 'state', name='biomarkervaluetype'), nullable=False, server_default='quantity'),
    sa.Column('supports_multi_state', sa.Boolean(), nullable=False, server_default=sa.text('false')),
    sa.Column('meta_data', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('scope', sa.Enum('system', 'tenant', 'user', name='catalogscope'), nullable=False),
    sa.Column('tenant_id', sa.UUID(), nullable=True),
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
