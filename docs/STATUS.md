...
- **0.3.0 security & critical-fix pass** (see [AUDIT-2026-06-21.md](../dev/audits/AUDIT-2026-06-21.md) and [CHANGELOG.md](../CHANGELOG.md)) — **all 29 Critical/High items resolved**:
...
6. **FHIR R4 Conformance**: CapabilityStatement, Bundle search responses, missing resources (Condition/Encounter/Device/Provenance), SDK multi-resource builders (audit Sections C/D).
